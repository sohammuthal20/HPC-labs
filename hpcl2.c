...
int main()
{
    ...
    // second argument is set attributes thread
    // fourth argument is used to pass arguments to function written as third argument
    ...
    // second argument could be used to catch return value from the function
